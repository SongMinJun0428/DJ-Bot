# 🎧 Alohang 스타일 디스코드 DJ 봇 가이드 (v2.8.0)
...
## 5. 기술 요구 사항 및 호스팅 (v2.8.0)

### 필수 환경
*   **Node.js**: **v22.12.0 이상** (디스코드 보안 패치 DAVE E2EE 대응 필수 버전)
*   **패키지**: `discord.js v14.17.3+`, `@discordjs/voice v0.18.0+`, `@snazzah/davey` (보안 패치)

### ⚠️ 중요: 2026년 음성 연결 문제 (Signalling Hang)
디스코드의 최신 보안 정책인 **DAVE (종단간 암호화)**로 인해, 오래된 버전의 봇이나 보안 라이브러리가 없는 봇은 `Signalling` 단계에서 멈추며 소리가 나오지 않습니다. 본 봇은 **v2.8.0**부터 이 문제를 해결하는 보안 패치를 포함하고 있습니다.
